...
public class Public_ {
	 ...
	 */
    public Public_(JSONObject json_data) {
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field lodging was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field lodging had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field educational was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field educational had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field totalConstruction was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field totalConstruction had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field transportation was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field transportation had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field power was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field power had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field office was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field office had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field nonresidential was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field nonresidential had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field amusementAndRecreation was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field amusementAndRecreation had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field residential was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field residential had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field publicSafety was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field publicSafety had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field conservationAndDevelopment was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field conservationAndDevelopment had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field commercial was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field commercial had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field waterSupply was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field waterSupply had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field healthCare was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field healthCare had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field sewageAndWasteDisposal was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field sewageAndWasteDisposal had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field communication was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field communication had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field manufacturing was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field manufacturing had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field religious was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field religious had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Public; the field highwayAndStreet was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Public; the field highwayAndStreet had the wrong structure.");
    		e.printStackTrace();
        }
