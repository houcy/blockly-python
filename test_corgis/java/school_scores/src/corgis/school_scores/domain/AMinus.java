...
public class AMinus {
    ...
    public AMinus(JSONObject json_data) {
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a AMinus; the field math was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a AMinus; the field math had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a AMinus; the field verbal was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a AMinus; the field verbal had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a AMinus; the field testTakers was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a AMinus; the field testTakers had the wrong structure.");
    		e.printStackTrace();
        }
