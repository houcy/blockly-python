...
public class A {
    ...
    public A(JSONObject json_data) {
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a A; the field math was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a A; the field math had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a A; the field verbal was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a A; the field verbal had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a A; the field testTakers was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a A; the field testTakers had the wrong structure.");
    		e.printStackTrace();
        }
