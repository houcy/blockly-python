...
public class MainPlusExtras {
    ...
    public MainPlusExtras(JSONObject json_data) {
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Main+Extras; the field average was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Main+Extras; the field average had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Main+Extras; the field median was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Main+Extras; the field median had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Main+Extras; the field polled was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Main+Extras; the field polled had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Main+Extras; the field leisure was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Main+Extras; the field leisure had the wrong structure.");
    		e.printStackTrace();
        }
        ...
        try {
    		...
    		System.err.println("Could not convert the response to a Main+Extras; the field rushed was missing.");
    		e.printStackTrace();
    	} catch (ClassCastException e) {
    		System.err.println("Could not convert the response to a Main+Extras; the field rushed had the wrong structure.");
    		e.printStackTrace();
        }
